              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                <div className="flex">
                  ...
                  <div className="ml-4 grow">
                    ...
                    Facilita a criação de mapas mentais. Possui um editor intuitivo que permite mapear ideias junto com sua equipe, de forma rápida e atrativa. Você pode acessar um tutorial em vídeo <a href="https://youtu.be/GbpDGemgFY4" target="_blank" className="text-blue-700 underline hover:text-purple-700">aqui</a>.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                <div className="flex">
                  ...
                  <div className="ml-4 grow">
                    ...
                    <p className="text-neutral-700 dark:text-neutral-300">
                    É um espaço de trabalho visual que mescla diagramação, visualização de dados e colaboração para acelerar a compreensão e promover a inovação. Você pode assistir a um tutorial em vídeo <a href="https://youtu.be/ILlPjxaT5u0" target="_blank" className="text-blue-700 underline hover:text-purple-700">aqui</a>.
                    </p>
                  </div>
                </div>
